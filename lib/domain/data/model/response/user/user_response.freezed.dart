...
abstract class $UserResponseCopyWith<$Res> {
  ...
  @useResult
  $Res call({@JsonKey(name: "data") UserDataResponse? data});
...
class _$_UserResponse implements _UserResponse {
  const _$_UserResponse({@JsonKey(name: "data") this.data});
...
abstract class _UserResponse implements UserResponse {
  const factory _UserResponse(
      {@JsonKey(name: "data") final UserDataResponse? data}) = _$_UserResponse;
